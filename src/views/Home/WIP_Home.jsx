...
import caps9 from '../../assets/caps9.png'
...
const Home = () => {
    ...
    const bulles = [
        ...
        },
        {
            ...
            videoId: "Ypx8ulWVdV0",
            text: "Bonjoir caveux et cavèsses,\nProduit de notre quotidien, le cafard saura aiguiller vos papilles vers les recoins les plus sombres de votre plaisir. Véritable rose des vents du bonheur, ce cancrelat se consomme vivant. Rien de plus délicieux que de sentir son cœur nous battre l’oesophage.\nUne bonne blatte s’évalue à deux phalanges. Plus petit, il sera trop croquant, plus gros, un rat d’un mois sera plus apprécié. De vos doigts crochus, pincez lui légèrement ses côtes pour empêcher quelque action infructueuse et détachez une à une ses belles pattes au poil dru. Ses billes noires vous regarderont impuissant, faites lui un beau sourire.\nConcernant les ailes, deux écoles : Pour les plus sadiques, une simple entaille au centre suffit. Le fardca aura beau taper la fréquence qu’il souhaite, il ne fera que balayer à sa porte. Pour ceux qui ont les chicots fatigués, l’écart de paradis à chaque briques, arrachez-les et servez-vous en fin de déguste.\nLe voilà dans sa plus belle forme, celle d’un indésirable tronc, prêt à être servit. Pour accompagner ce snack, rien de mieux qu’une sauce maison : Récupérez vos fins de poussières.\nÀ l’aide d’une pipette, prélevez 1 centilitre d’eau stagnante et mélangez le tout avec un clou dans un récipient oxydé.\nDernier conseil, n’hésitez pas à jouer avec tout le long. Un taux de stress élevé avant le croc raffermi sa chair. »\nLa porte s’ouvre, une lumière intense vient éclairer le stand aveuglant les petites bêtes. Le vieil homme attrape le cuistot et crie à sa femme : « Ce soir c’est moi qui cuisine, j’ai une bonne recette. »"
        },
        {
            style: {
                size: "18vh",
            ...
            videoId: "OExUvQJr0iE",
            text: "C’est par delà les larmes que j’ai compris. Une fois qu’il n’y en avait plus. Par leur honteuse absence, j’ai saisi. Qu’elles demandaient un reste. Quelque-chose. De la force. Il faut être fort pour pleurer. Les larmes sont pleines d’un reste d’espoir qu’elles écoulent et emmènent s’écraser avec elle à nos pieds. Mais quand elles ont fini de couler, quand il n’y a plus rien qu’elles puissent emmener avec elles. Quand le torrent s’est asséché, que la mer n’est plus, alors là, là est le réel terrassement de la tristesse. C’est à ce moment que l’on expérimente le vide complet et terrifiant de sa propre solitude. C’est à ce point d’aridité que l’on touche les frontières de ses résistances, que l’on caresse les fondations avec angoisse. Il est là notre désespoir le plus pur, quand même l’armure de larmes est tombée."
        }
    ]
